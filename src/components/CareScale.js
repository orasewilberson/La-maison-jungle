...
//Vous auriez aussi pu utiliser une fonction qui retourne l'élément 
// souhaité, ou bien faire directement des conditions
const quantityLabel = {
    1: 'peu',
    2: 'modérément',
    3: 'beaucoup'
...
function CareScale (scaleValue, careType) {
    ...
    return (
        <div onClick={() =>
            ...
            {range.map((rangElem) => 
                scaleType >= rangElem ? (<span key={rangElem.toString()}>{scaleType}</span>) : null
            )}
        </div>
        )
}
